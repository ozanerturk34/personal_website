import { ArticleBuilder, Article } from "@models/Article";
...
].map((article) => ArticleBuilder.mapToArticle(article));
...
class MockArticlesAPI {
  ...
  public readonly getArticles = (): Article[] => this._articles;

  public readonly findArticleById = (id: string): Article | undefined =>
